    ...
    def build(self):
        ...
        class CrossConfirmationMNBAgentModel(Model):
            ...
            def act(self, observation, features):
                ...
                if predictions_0[action_0] + predictions_1[action_1] + predictions_2[action_2] <= self.config.fallback_threshold:
                    action = np.argmax(features)
                    print('argmax')
                else:
                    if predictions_0[action_0] >= predictions_1[action_1] and \
                            predictions_0[action_0] >= predictions_2[action_2]:
                        action = action_0
                    elif predictions_1[action_1] >= predictions_0[action_0] and \
                            predictions_1[action_1] >= predictions_2[action_2]:
                        action = action_1
                    else:
                        action = action_2
                    print(action)
